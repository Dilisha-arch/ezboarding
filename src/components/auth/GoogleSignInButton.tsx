...
export function GoogleSignInButton({
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // Reset loading in case redirect is blocked or delayed
            setIsLoading(false);
        }
    };
    ...
    return (
        <Button
            ...
            variant="outline"
            className={cn(
                "w-full h-10 rounded-xl font-semibold flex items-center justify-center gap-3 transition-all active:scale-95 border-gray-200 hover:bg-gray-50 hover:border-gray-300",
                className
            )}
